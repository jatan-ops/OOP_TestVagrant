...
public class ValidateCityAndTemp {
    ...
    private void weatherWebPage (WebDriver driver){
    ...
    private void searchCity (String name, WebDriver driver){
    ...
    private void selectCity (String name, WebDriver driver){
    ...
    private boolean validateCityAndTemp (String name, WebDriver driver){
